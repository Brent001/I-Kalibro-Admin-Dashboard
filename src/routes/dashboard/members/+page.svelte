...
<Layout>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      ...
      <button class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-slate-900 hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-colors duration-200">
      ...
      <div class="bg-white p-4 rounded-lg shadow-sm border">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-semibold text-gray-900">{members.filter(m => m.status === 'Active').length}</p>
          </div>
        </div>
      </div>
      <div class="bg-white p-4 rounded-lg shadow-sm border">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-semibold text-gray-900">{members.filter(m => m.type === 'Student').length}</p>
          </div>
        </div>
      </div>
      <div class="bg-white p-4 rounded-lg shadow-sm border">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            <p class="text-sm font-medium text-gray-600">Faculty & Staff</p>
            <p class="text-2xl font-semibold text-gray-900">{members.filter(m => m.type === 'Faculty' || m.type === 'Staff').length}</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="flex-1">
          <div class="relative">
            ...
            <input
              ...
              class="pl-10 pr-4 py-2 w-full border border-gray-300 rounded-md focus:ring-2 focus:ring-slate-500 focus:border-slate-500"
            />
          </div>
        </div>
        <div>
          <select
            ...
            class="px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-slate-500 focus:border-slate-500"
          >
    ...
    <!-- Pagination -->
    <div class="bg-white px-6 py-3 border rounded-lg flex items-center justify-between">
      ...
      <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
        <button class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-l-md text-gray-500 bg-white hover:bg-slate-50 transition-colors duration-200">
          <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <button class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-500 bg-white hover:bg-slate-50 transition-colors duration-200">
          Next
